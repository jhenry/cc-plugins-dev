...
try {
    ...
    if (!file_exists ($rawVideo)) throw new Exception("The raw video file does not exists. The id of the video is: $video->videoId . The expected raw video path is: $rawVideo . The upload path is: " . UPLOAD_PATH);
